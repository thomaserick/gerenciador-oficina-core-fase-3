package com.fiap.pj.core.estimate.adapter.in.api.openapi;
...
public interface EstimateControllerOpenApi {
    ...
    ResponseEntity<Void> createEstimate(@Valid @RequestBody CreateEstimateCommand cmd);
