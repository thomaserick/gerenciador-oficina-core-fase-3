...
class DeactivateUsuarioControllerTest {
    ...
    @Test
    void ShouldInativarUser() throws Exception {
        mock.perform(post(
                TestUtils.buildURL(UsuarioController.PATH, UUID.randomUUID().toString(), "deactivate"))
