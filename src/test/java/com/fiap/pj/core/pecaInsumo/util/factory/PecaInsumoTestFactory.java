...
public class PecaInsumoTestFactory {
    ...
    public static final Integer ALTER_QUANTIDADE_MINIMO_ESTOQUE = 3;

    public static PecaInsumo onePecaInsumo() {
        return new PecaInsumo(ID, NOME, DESCRICAO, VALOR_UNITARIO, QUANTIDADE_ESTOQUE, QUANTIDADE_MINIMO_ESTOQUE);
    }

    public static CriarPecaInsumoCommand oneCreatePecaInsumoCommand() {
        return new CriarPecaInsumoCommand(NOME, DESCRICAO, VALOR_UNITARIO, QUANTIDADE_ESTOQUE, QUANTIDADE_MINIMO_ESTOQUE);
    }

    public static AlterarPecaInsumoCommand umUpdatePecaInsumoCommand(UUID id) {
        return new AlterarPecaInsumoCommand(ALTER_NOME, ALTER_DESCRICAO, ALTER_VALOR_UNITARIO, ALTER_QUANTIDADE_ESTOQUE, ALTER_QUANTIDADE_MINIMO_ESTOQUE);
    }
} 