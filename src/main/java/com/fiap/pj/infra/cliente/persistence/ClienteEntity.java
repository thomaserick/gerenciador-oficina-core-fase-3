...
public class ClienteEntity {
    ...
    public ClienteEntity(UUID id, String nome, String email, String telefone, boolean ativo, String endereco, DocumentoIdentificacao documentoIdentificacao, Set<Veiculo> veiculos) {
