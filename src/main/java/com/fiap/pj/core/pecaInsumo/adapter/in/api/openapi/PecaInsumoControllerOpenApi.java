package com.fiap.pj.core.pecaInsumo.adapter.in.api.openapi;
...
public interface PecaInsumoControllerOpenApi {
    ...
    ResponseEntity<com.fiap.pj.core.sk.web.ResponseEntityUtils.ResponseId> criarPecaInsumo(@RequestBody CriarPecaInsumoCommand cmd);
