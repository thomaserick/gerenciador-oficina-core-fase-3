...
import static com.fiap.pj.core.pecaInsumo.util.factory.PecaInsumoTestFactory.umUpdatePecaInsumoCommand;
...
class AlterarPecaInsumoControllerTest {
    ...
    void deveAlterarPecaInsumo() throws Exception {
        ...
        mock.perform(put(
                ...
                .content(TestUtils.objectToJson(umUpdatePecaInsumoCommand(id)))).andExpect(status().isOk());
